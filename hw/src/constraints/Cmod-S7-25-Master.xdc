...
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { Vaux5_0_v_p }]; #IO_L12P_T1_MRCC_AD5P_15 Sch=ain_p[32]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { Vaux5_0_v_n }]; #IO_L12N_T1_MRCC_AD5N_15 Sch=ain_n[32]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { Vaux12_0_v_p }]; #IO_L11P_T1_SRCC_AD12P_15 Sch=ain_p[33]
set_property -dict { PACKAGE_PIN A12   IOSTANDARD LVCMOS33 } [get_ports { Vaux12_0_v_n }]; #IO_L11N_T1_SRCC_AD12N_15 Sch=ain_n[33]
